const Form = ({ checkBlockId, checkBoxId }) => {
    ...
    return (
        <form className="ajaxForm" action="https://formcarry.com/s/kW0qF4VTJD_" acceptCharset="UTF-8">
            ...
            <textarea name="" className="comment" cols="30" rows="10" type="text" placeholder="Ваш комментарий">
            </textarea>
            <div id={checkBlockId}>
            ...
            <div className="from__submit">
                <input disabled={!formValid}  id="submit" className="form__button" type="submit" value="ОСТАВИТЬ ЗАЯВКУ!" />
